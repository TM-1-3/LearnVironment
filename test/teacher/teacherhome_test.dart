...
class MockDataService extends Mock implements DataService {
  ...
  Future<UserData?> getUserData({required String userId}) {
    return Future.value(UserData(role: '', id: '', username: '', name: '', email: '', birthdate: DateTime(2000, 1, 1, 0, 0, 0, 0, 0), gamesPlayed: [], tClasses: [], stClasses: [], img: 'assets/placeholder.png'));
  }
}
